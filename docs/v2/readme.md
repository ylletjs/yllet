...
Yllet comes with [tree-shakable](https://webpack.js.org/guides/tree-shaking/) ESM or CJS builds. All code are tiny and well tested with both unit and browser tests.
