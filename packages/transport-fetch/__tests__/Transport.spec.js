...
describe("fetch calls", () => {
  verbs.forEach(verb => {
    test(`${verb} calls fetch once`, () => {
      resetMocks();
      transport.fetch(verb, "https://wp.com/wp-json");
...
describe("headers", () => {
  ...
  verbs.forEach(verb => {
    test(`${verb} sends correct headers`, () => {
      resetMocks();
      transport.fetch(verb, "https://wp.com/wp-json", {}, config);
...
describe("with data", () => {
  ...
  verbs.forEach(verb => {
    test(`${verb} sends data`, () => {
      resetMocks();
      transport.fetch(verb, "https://wp.com/wp-json", data);
      if (verb === "GET") {
...
describe("returns json", () => {
  verbs.forEach(verb => {
    test(`${verb} returns data`, () => {
      resetMocks();
      transport.fetch(verb, "https://wp.com/wp-json").then(response => {
...
describe("http exceptions", () => {
  verbs.forEach(verb => {
    test(`${verb} throws http exceptions`, () => {
      ...
      transport.fetch(verb, "https://wp.com/wp-json").catch(error => {
